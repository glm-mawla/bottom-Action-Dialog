...
import com.glmmawla.bottomdialog.databinding.WidgetRatingBarBinding

class RatingBarWidget : ConstraintLayout {

    private var binding: WidgetRatingBarBinding = WidgetRatingBarBinding.bind(
...
//        ratebarAdapter.notifyDataSetChanged()
    ...
    open class RatingBarAdapter(
        ...
        override fun onBindViewHolder(ratingBarAdapterViewHolder: RatingBarAdapterViewHolder, position: Int) {
